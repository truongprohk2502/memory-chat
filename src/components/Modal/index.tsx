    ...
    <Portal isOpen={isOpen}>
      ...
      <div
        className={clsx(
          ...
          `min-h-96 bg-white rounded-lg 0 z-50 fixed left-1/2 transition-all duration-300 transform -translate-x-1/2 -translate-y-1/2 ${className}`,
        )}
      >
        <div className="flex justify-center px-4 py-2 relative border-b border-gray-300">
